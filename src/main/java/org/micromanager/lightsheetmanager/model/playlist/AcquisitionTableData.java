package org.micromanager.lightsheetmanager.model.playlist;//package org.micromanager.lightsheetmanager.table;
...
public class AcquisitionTableData {
    ...
    public AcquisitionTableData() {
        metadata_ = new ArrayList<>(DEFAULT_CAPACITY);
        settings_ = new HashMap<>(DEFAULT_CAPACITY);
        positions_ = new LinkedHashMap<>(DEFAULT_CAPACITY);
    }
...
//    }
    ...
    public boolean acqNameExists(final String name) {
        return settings_.get(name) != null;
    }
